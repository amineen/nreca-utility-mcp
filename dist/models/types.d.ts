...
export type MemoType = "Cash payment" | "Mobile payment" | "Payment reversal" | "Cash payment - import";
export declare const CustomerTypes: {
    readonly RESIDENTIAL: "Residential";
    readonly COMMERCIAL: "Commercial";
    readonly INDUSTRIAL: "Industrial";
    readonly PUBLIC_FACILITY: "Public Facility";
